namespace Sefacan.Core.Infrastructure
{
    public class MimeTypes
    {
        #region application/*
        public const string ApplicationAllTypes = "application/*";
        ...
        #region image/*
        public const string ImageAllTypes = "image/*";
        ...
        #region text/*
        public const string TextAllTypes = "text/*";
