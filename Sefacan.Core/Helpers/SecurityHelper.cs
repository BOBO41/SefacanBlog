...
namespace Sefacan.Core.Helpers
{
    public static class SecurityHelper
    {
        //public static string EncryptKey = string.Empty;

        private const string EncryptKey = "uNuFu9LRnurYZXxrhh2KmkTSYDSgC4sL4Xm8hGMWCwctrsLs7hVbH8PEMeqhhBpB"; //"5LWVB9FBLuTW5fVGfQTKX7wdzz4Kb692";
