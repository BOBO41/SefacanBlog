...
namespace Sefacan.Data
{
    public class Repository<T> : IRepository<T> where T : BaseEntity
    {
        ...
        private const string UpdateDatePropertyName = "UpdateDate";

        public bool IsSetAutoEditableValue { get; set; }
        ...
        public bool Insert(T entity)
        {
            try
            {
                ...
                if (IsSetAutoEditableValue && entity.HasProperty(CreateDatePropertyName))
                    entity.SetPropertyValue(CreateDatePropertyName, DateTime.Now);
        ...
        public bool Update(T entity)
        {
            try
            {
                ...
                if (IsSetAutoEditableValue && entity.HasProperty(UpdateDatePropertyName))
                    entity.SetPropertyValue(UpdateDatePropertyName, DateTime.Now);
